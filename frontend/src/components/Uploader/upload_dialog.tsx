...
export default function upload_dialog({
	...
	const render_project_selector_section = () => {
		if (url_project_id || !projects || projects.length === 0) return undefined
	...
	const render_dataset_options_section = () => {
		if (!should_show_dataset_options || is_all_complete) return undefined
		return (
			<div className="space-y-3">
				<label
			...
			<div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
				...
				>
					...
					>
						...
						{render_project_selector_section()}
						{render_dataset_options_section()}
